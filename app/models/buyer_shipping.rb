class BuyerShipping
  ...
  with_options presence: true do
    validates :user_id, :city, :address1, :token, :item_id
  ...
  def save
    ...
    Shipping.create(zip_code: zip_code, prefecture_id: prefecture_id, city: city, address1: address1, address2: address2,
                    telephone: telephone, buyer_id: buyer.id)
  end
end
